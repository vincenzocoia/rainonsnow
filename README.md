...
# Sentinel-1 wet-snow fraction reduced to the ERA5-Land grid, in Earth Engine.
# Reuses the existing `earthengine authenticate` credentials.
uv run python scripts/1c-download_data-s1_wetsnow.py

# CLMS Soil Water Index / Surface Soil Moisture / Snow Cover Extent via CDSE
# OData. Needs a free account: export CDSE_USERNAME and CDSE_PASSWORD.
