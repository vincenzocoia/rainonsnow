...
Rcpp::sourceCpp("src/gev_anchored.cpp", cacheDir = "src/.rcpp-cache")
Rcpp::sourceCpp("src/gpd_expectile.cpp", cacheDir = "src/.rcpp-cache")
Rcpp::sourceCpp("src/gpd_elastile.cpp", cacheDir = "src/.rcpp-cache")
