...
<div class="eq"><div class="body">&#8747;&#8320;&sup1; w(p) g&#8202;<sub>p</sub><sup>F</sup>(T&#8202;<sub>p</sub>(&theta;)) &nabla;&#8202;<sub>&theta;</sub>T&#8202;<sub>p</sub>(&theta;) dp = 0</div><div class="tag">(6)</div></div>
<div class="col">
<p>with the sensitivity following by implicit differentiation of the defining equation,</p>
</div>
<div class="eq"><div class="body">&nabla;&#8202;<sub>&theta;</sub>T&#8202;<sub>p</sub>(&theta;) = &minus; [&part;g&#8202;<sub>p</sub><sup>F<sub>&theta;</sub></sup>/&part;&theta;] / [&part;g&#8202;<sub>p</sub><sup>F<sub>&theta;</sub></sup>/&part;t]   at t = T&#8202;<sub>p</sub>(&theta;)</div><div class="tag">(7)</div></div>
<div class="col">
...
T<sub>p</sub>(&theta;) is the truth's own level-p M-quantile. So (6) says the pseudo-true parameter
...
is matched. Section 5.5 solves (6) numerically and finds that concentrating w drives &theta;*
...
<div class="eq"><div class="body">&#8747; w(p)[p &minus; F(T&#8202;<sub>p</sub>)] T&#8202;<sub>p</sub> dp = 0,   &#8747; w(p)[p &minus; F(T&#8202;<sub>p</sub>)] (1&minus;p)<sup>&minus;&xi;</sup> log[1/(1&minus;p)] dp = 0</div><div class="tag">(8)</div></div>
<div class="col">
<p>For the other members T<sub>p</sub> has no elementary form, but (7) still delivers
...
<div class="col">
<p>The comparisons above are at a fixed sample size. Solving (6) removes the sampling noise and
...
from (6) to a residual below 10<sup>&minus;10</sup>. The likelihood limit minimises
